    ...
    <CssVarsProvider theme={appleTheme} defaultMode="dark">
      <Box sx={{
        ...
        <Box sx={{ mb: 4 }}>
          ...
          >
            View and manage all expired gym members
          </Typography>
        </Box>
                  ...
                  <tr key={member.id}>
                    ...
                    <td>
                      <Chip
                        variant="soft"
                        size="sm"
                        startDecorator={statusMapping["expired"].icon}
                        sx={{
                          bgcolor: statusMapping["expired"].bgColor,
                          color: statusMapping["expired"].textColor,
                          fontSize: "12px",
                          fontWeight: 500,
                    ...
                    <td>
                      <Stack direction="row" spacing={1}>
                        ...
                        <Dropdown>
                          ...
                          >
                            <MenuItem onClick={() => handleBlockMember(member.id)} sx={{ color: "danger.plainColor" }}>
                              Block Member
                            </MenuItem>
